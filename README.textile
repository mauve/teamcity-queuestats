...
p. This project uses ant for building, but mostly because I am lazy. I use Eclipse for editing and use ant for deploying and so on. You can build and compile from within
Eclipse as the project file is correctly setup, but the ant file creates the plugin zip file and copies it to the TeamCity plugin directory.
